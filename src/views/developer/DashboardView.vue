<template>
  <div class="min-h-screen bg-primary">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      :data="usageData"
      :max="5000"
      title="Penggunaan API (7 Hari Terakhir)"
      />
    <QuickAction />
  </div>
</div>
...
<script setup>
import { Header, Navbar, WelcomeMessage, StatCard, QuickAction, UsageChart } from './components'
...
// Singkatan hari sudah diubah ke bahasa Indonesia
const usageData = [
{ day: 'Sen', requests: 2847 },
{ day: 'Sel', requests: 3124 },
{ day: 'Rab', requests: 2956 },
{ day: 'Kam', requests: 4201 },
{ day: 'Jum', requests: 3789 },
{ day: 'Sab', requests: 1543 },
{ day: 'Min', requests: 1591 }
]
