    ...
    <div class="w-full max-w-sm relative z-10 anim-fade-up">
      ...
      <div class="rounded-2xl border overflow-hidden"
        ...
        <div class="px-7 pt-7 pb-5 border-b" style="border-color:rgba(44,99,209,0.08);">
          ...
          <p class="text-xs mt-1" style="color:#6b7fa3;">Masuk untuk mulai mendeteksi ancaman quishing</p>
        </div>
          ...
          <form @submit.prevent="handleLogin" class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-1.5">
              ...
              <div class="relative">
                ...
                <input
                  v-model="username" type="text" required placeholder="your@email.com"
        ...
        <div class="px-7 pb-6 text-center">
          <p class="text-xs" style="color:#9baac5;">
            Belum punya akun?
            <RouterLink to="/register" class="font-semibold transition-colors" style="color:#2c63d1;">
              Daftar sekarang
            </RouterLink>
          </p>
        </div>
...
const handleLogin = async () => {
  ...
  if (result.success) {
    ...
    else if (authStore.userRole === 'user')  router.push('/developer')
